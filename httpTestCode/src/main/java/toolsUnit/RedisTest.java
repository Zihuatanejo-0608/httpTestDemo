...
public class RedisTest {
    ...
    public static String redisData(String key){
        try{
            ...
            nodes.add(new HostAndPort("172.17.46.11",36379));
            nodes.add(new HostAndPort("172.17.46.11",36381));
            nodes.add(new HostAndPort("172.17.46.12",36379));
            nodes.add(new HostAndPort("172.17.46.12",36381));
            nodes.add(new HostAndPort("172.17.46.13",36379));
            nodes.add(new HostAndPort("172.17.46.13",36381));
